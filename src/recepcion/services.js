            ...
            imprimir: function(entrega, configuracion, proveedor) {
				...
				try{
							...
							table: {
					            ...
					            body: [
					                ...
					                [
					                    ...
					                    {text: entrega.acta.empresa.nombre,colSpan: 5,style: "tableHeaderData",alignment: "center"},{},{},{},{}
					                ],
					                [
					...
					dd.content[0].table.body.push(
		                ...
		                [
		                    {text: "LUGAR DE ENTREGA: "+entrega.acta.lugar_entrega,style: "tableFooter",colSpan: 11,alignment: "justify"},{},{},{},{},{},{},{},{},{},{}
		                ],
		                [{
	                        table: {
	                            widths: ["*","*","*"],
